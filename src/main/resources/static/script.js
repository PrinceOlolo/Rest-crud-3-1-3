    ...
    fetch("http://localhost:8080/api/admin/findAllUsers")
        ...
        .then((data) => {
            ...
            data.forEach(function (u) {
                ...
                temp += ' <td> <button class="btn btn-primary " type="button" data-toggle="modal" ' +
                    'data-target="#editModal" onClick="fillModal(' + u.id + ')">Edit</button> </td>';
                temp += ' <td> <button class="btn btn-danger" type="button" data-toggle="modal" ' +
